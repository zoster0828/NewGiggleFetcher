...
//        FetchingUsecaseInput fetchingUsecaseInput = new FetchingUsecaseInput(20, List.of("BLIND", "OPGG", "DAUMCAFE", "THEQOO"));
        FetchingUsecaseInput fetchingUsecaseInput = new FetchingUsecaseInput(20, List.of("THEQOO"));
